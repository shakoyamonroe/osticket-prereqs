...
Step 1: Create Azure VM (Windows 10)
Provision a VM named osticket-vm using a Windows 10 image via the Azure Portal.
...
Use Remote Desktop (RDP) to connect to the new VM.
